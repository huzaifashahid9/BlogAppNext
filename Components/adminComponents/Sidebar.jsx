...
const Sidebar = () => {
  return (
    <div className="flex flex-col bg-slate-100">
      <Link href={"/"}>
      <div className="cursor-pointer px-2 sm:pl-14 py-3 border border-black">
      ...
      <div className="w-28 sm:w-80 h-[100vh] relative py-12 border border-black">
        ...
        <Link href="/admin/addProduct">
          <div className="flex items-center border m-5 border-black gap-3 font-medium px-3 py-2 bg-white shadow-[-5px_5px_0px_#000000] transition-all duration-200 hover:bg-black hover:text-white hover:scale-105">
